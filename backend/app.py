...
define('spotify_client_id', default=os.environ.get('SPOTIFY_CLIENT_ID'), help="spotify api id")
define('spotify_secret', default=os.environ.get('SPOTIFY_SECRET'), help="spotify secret")
